        ...
        <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
          {!aiAnalysis ? (
            ...
            <div className="space-y-4 animate-fade-in">
              ...
              {/* AI Source Indicator */}
              {aiAnalysis.source === 'demo' && (
                <div className="bg-yellow-900/30 border border-yellow-600/50 rounded-lg p-3">
                  <div className="flex items-center gap-2">
                    <AlertTriangle className="text-yellow-400" size={18} />
                    <span className="text-yellow-400 font-semibold text-sm">Demo Mode</span>
                  </div>
                  <p className="text-yellow-200/70 text-xs mt-1">
                    AI APIs temporarily unavailable. Using fallback analysis.
                  </p>
                </div>
              )}
              {aiAnalysis.source && aiAnalysis.source !== 'demo' && (
                <div className="bg-green-900/20 border border-green-700/30 rounded-lg p-3">
                  <div className="flex items-center gap-2">
                    <Brain className="text-green-400" size={18} />
                    <span className="text-green-400 font-semibold text-sm capitalize">
                      AI Powered by {aiAnalysis.source}
                    </span>
                  </div>
                  <p className="text-green-200/70 text-xs mt-1">
                    Real-time analysis generated by {aiAnalysis.source} AI.
                  </p>
                </div>
              )}
